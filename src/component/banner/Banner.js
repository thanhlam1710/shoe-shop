                        ...
                        <div className="carousel-item position-relative active" style={{height: '430px'}}>
                            ...
                            <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div className="p-3" style={{maxWidth: '700px'}}>
                                    <h1 className="display-4 text-white mb-3 animate__animated animate__fadeInDown">Thời trang mới</h1>
                                    ...
                                    <a className="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="a">Mua ngay</a>
                                </div>
                            </div>
                        </div>
            ...
            <div className="col-lg-4">
                <div className="product-offer mb-30" style={{height: '200px'}}>
                    ...
                    <div className="offer-text">
                        ...
                        <h3 className="text-white mb-3">Giảm cực sốc</h3>
                        <a href="a" className="btn btn-primary">Mua ngay</a>
                    </div>
                </div>
                <div className="product-offer mb-30" style={{height: '200px'}}>
